                ...
                <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div x-show="tab === 'data_diri'">
                        <div class="grid w-3/4 grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                            ...
                            <select x-model="formData.pendidikan" name="pendidikan" class="w-full p-3 border rounded-lg"
                                required>
                            ...
                            <select x-model="formData.pekerjaan" name="pekerjaan" class="w-full p-3 border rounded-lg"
                                required>
                            ...
                            <!-- Upload KTP/SIM -->
                            <div class="col-span-2">
                                <input type="file" name="ktp" @change="formData.ktp = $event.target.files[0]"
                                    class="w-full p-2 border rounded-md">
                            </div>

                            <!-- Riwayat organisasi -->
                            <div class="col-span-2">
                                <input x-model="formData.riwayat_organisasi" type="text" name="riwayat_organisasi"
                                    placeholder="Riwayat Organisasi" class="w-full p-2 border rounded-md">
